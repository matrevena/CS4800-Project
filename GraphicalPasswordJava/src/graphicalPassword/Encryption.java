...
public class Encryption
{
	...
	public static void main(String text, JFrame mainFrame, JPanel mainPanel, JPanel overlayPanel, JLabel pictureLabel, String userName)
	{
		 try 
		 {
			 ...
			 SavePassword.main(mainFrame, mainPanel, overlayPanel, pictureLabel, passName, text, filePath, clickCoords, clickSizes, userName);
