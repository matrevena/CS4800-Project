...
public class CreatePassword {
	...
	public static void main(String directory, JFrame mainFrame, JPanel mainPanel, JPanel overlayPanel, JLabel pictureLabel, JMenuBar menuBar, JMenu controlsMenu, JMenu userMenu, String userName)
	{	
		String filePath = MainGUI.fileChooser(directory);
		
		initiateEdit(filePath, mainFrame, mainPanel, overlayPanel, pictureLabel, menuBar, controlsMenu, userMenu, userName);		
	}
	
	public static void initiateEdit(String filePath, JFrame mainFrame, JPanel mainPanel, JPanel overlayPanel, JLabel pictureLabel, JMenuBar menuBar, JMenu controlsMenu, JMenu userMenu, String userName)
	{
		if (filePath != null)
		{
					...
					if (numOfCoords >= 4)
					{
						...
						if (creationPanelR.isVisible())
						{
							...
							if (passName.length() >= 4 && passName.length() <= 20)
							{
								...
								{
									SavePassword.main(mainFrame, mainPanel, overlayPanel, pictureLabel, passName, textPass, filePath, clickCoords, clickSizes, userName);
	...
	{	
		...
		int y = 0;
		creationPanelR.setBounds(x - 5, y, menuWidth, menuHeight);
		...
		ActionListener randomPassE = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textPasswordTfR.isEnabled() == false)
				{
					...
					randomPassBtnR.setText("Custom");
					randomPassBtnL.setText("Custom");
					mainFrame.revalidate();
					mainFrame.repaint();
				}
